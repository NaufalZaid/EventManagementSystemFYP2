<x-layouts.app title="Administrator dashboard">
    <x-page-header title="Administrator dashboard" description="Manage scheduling master data and monitor the current prototype workspace.">
    ...
    <div class="mt-6 grid gap-6 lg:grid-cols-3">
        ...
        <section class="rounded-2xl border border-purple-200 bg-purple-50 p-6"><span class="text-xs font-semibold uppercase tracking-wider text-purple-700">Intelligent scheduling</span><h2 class="mt-2 font-semibold text-slate-900">GA schedule optimizer</h2><p class="mt-2 text-sm leading-6 text-slate-600">Evolve candidate assignments, enforce hard constraints, score preferences, and compare results with manual schedules.</p><a href="{{ route('optimizer.index') }}" class="mt-5 inline-flex rounded-lg bg-purple-600 px-3.5 py-2 text-xs font-semibold text-white">Run optimizer →</a></section>
    </div>
</x-layouts.app>
